...
import org.newsextractor.filter.SkeletonFilter;
import org.newsextractor.io.HtmlFileReader;
import org.newsextractor.production.HtmlArchive;
import org.newsextractor.production.HtmlWrapper;
 ...
 * 
 * @author firstprayer
 * Class defined for html files cluster
 */
public class HtmlPattern {
	...
	public final static class UrlPattern 
	{
		...
		/**
		 * This is used for further manipulation
		 */
	 ...
	 * 
	 * @author firstprayer
	 * class describe a pattern of html dom tree
	 */
		...
		try {
			...
			while((urlPatternAndHtmlsIterator.hasNext()))
			{
				...
				while(filePathIterator.hasNext())
				{
					...
					String textContent = HtmlFileReader.getHtmlContentSafely(filePathString);
					textContent = HtmlManipulator.getSingleton().RuleOutUselessText(textContent);
